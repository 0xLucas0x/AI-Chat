# Getting Started with AI Chat.ai

This guide will help you get AI Chat.ai up and running on your system.
...
```bash
git clone https://github.com/AI Chat/AI Chat.ai.git
cd AI Chat
```
...
```bash
xattr -d com.apple.quarantine /Applications/AI Chat.app
```

## Next Steps

- Check out our [documentation](https://deepwiki.com/AI Chat/AI Chat.ai/) for detailed guides
