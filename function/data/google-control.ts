...
const redirect_uri = process.env.NEXT_PUBLIC_GOOGLE_OAUTH_REDIRECT_URI || "https://localhost:3000/oauth2callback";
...
export async function getFolderList() {
  const url = getGoogleAjaxUrl("https://www.googleapis.com/drive/v3/files", {
    ...
    q: "mimeType='application/vnd.google-apps.folder' and name = 'AI ChatBackup'",
  });
