...
export const metadata: Metadata = {
  ...
  title: "AI Chat - Interactive Storytelling Platform",
  description: "AI Chat is an innovative interactive storytelling platform that brings your stories to life. Create, share, and experience unique narratives in a fantasy-themed environment.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AI Chat - Interactive Storytelling Platform",
      },
    ],
  },
  twitter: {
